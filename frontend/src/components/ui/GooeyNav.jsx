...
export default function GooeyNav({
  ...
  const prevIndexRef = useRef(activeIndexProp ?? initialActiveIndex);
  ...
  const getActiveElement = () => {
    ...
    return activeLi?.querySelector('a') || activeLi;
  };
  ...
  useEffect(() => {
    ...
    if (clickedIndexRef.current === activeIndex) {
  ...
  return (
    <div className={`gooey-nav-container${reducedMotion ? ' is-reduced' : ''}${className ? ` ${className}` : ''}`} ref={containerRef}>
